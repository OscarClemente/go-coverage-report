...
URL="https://github.com/OscarClemente/go-coverage-report/releases/download/${VERSION}/${FILENAME}"
...
if ! [[ "$SHA256SUM" ]] ; then
  ...
  URL="https://github.com/OscarClemente/go-coverage-report/releases/download/${VERSION}/checksums.txt"
  cd .github/outputs
